...
import ProductDetail from "../../components/Admin/ProductDeatil";
import OrderDetail from "../../components/Admin/OrderDeatil";
  ...
  return (
    <div>
      ...
      <div className="top mb-5 px-5 mt-5">
        <div className=" bg-gray-300 py-5 border border-gray-800 rounded-lg flex justify-between px-10 items-center">
          <h1 className=" text-center text-2xl font-bold text-gray-800">
            Admin Dashboard
          </h1>
          <button
            onClick={logOutFunction}
            className=" text-center text-xl font-bold  hover:text-white bg-gray-800 text-gray-200 hover:bg-black p-2 rounded-lg"
          >
            Logout
          </button>
        </div>
          ...
          <Tabs>
            <TabList className="flex flex-wrap -m-4 text-center justify-center">
              ...
              <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                <div className=" border text-gray-900 hover:text-white  bg-gray-400 hover:bg-gray-900 border-gray-800 px-4 py-3 rounded-xl">
